...
$Obj_Paginador->EnlaceListar = "mod=ser&form=li"; //Define el enlace al modulo y formulario listar de ese módulo
      ...
      <div class="form-row">
        <div class="col-md-4">
          ...
          <div class="col-md-5">
            ...
            onClick="location.replace('presentacion/conf.php');">
            <i class="material-icons">&#xe879;</i><span>Cerrar</span></button>
            <button type="button" class="btn btn-success" onclick="location.replace('index.php?mod=ser&form=nu');">
          ...
          <tbody>
            ...
            foreach ( $Obj_Paginador->RegistrosPaginados as $Fila ) {
              ...
              <tr>
                ...
                <td>
                  <a href="index.php?mod=ser&form=ed&id=<?php echo $Fila['IdServicio'];?>" class="edit"><i class="material-icons" data-toggle="tooltip"
                    title="Editar">&#xE254;</i></a>
                    <a href="#" class="delete" onclick="Eliminar('<?php echo $Fila['IdServicio']; ?>');"><i class="material-icons" data-toggle="tooltip"
                      title="Eliminar">&#xE872;</i></a>
                </td>
              </tr>
                <?php
